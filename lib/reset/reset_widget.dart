          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'This will notify an admin person that the below account has requested a password reset. The admin person will send an email to the associated email address containing the new password.',
